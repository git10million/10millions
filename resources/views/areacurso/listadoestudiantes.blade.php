...
<div class="row row-docttus">
    <div class="col-md-12">       
      <h1 style="font-weight: 600; font-size: 20px;">Listado de Estudiantes</h1>
      ...
      request.done(function(obj) { 
         if(obj.status=="ok"){
            ...
            for(var i=0;i<obj_data.length;i++){                
                ...
                cadena_tabla+='   <td>('+obj_data[i].NombreUsuario+") "+obj_data[i].NombrePersona+' '+((obj_data[i].ApellidosPersona)?obj_data[i].ApellidosPersona:'')+'</td>';
