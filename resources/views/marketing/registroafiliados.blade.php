        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-12" style="text-align: center;">             
              ...
              <h1 style="font-size: 48px; color: #fff; margin-top: 100px;">Registro Afiliado</h1>
              ...
              <div class="row">
                <div class="offset-md-2 col-md-8">
                  <form class="form" id="formulario_login">
                     ...
                     <h4 style="text-align: center;">Sé parte de la nueva generación de marketeros digitales y Gana hasta un 70%.</h4>
