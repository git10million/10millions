...
<div class="row row-docttus">
    ...
    <div class="col-md-9">       
        ...
        <div class="card-docttus card-docttus-left" style=" height: auto !important; text-align: left; margin-top: 25px;">
          ...
          <h4 style="font-weight: bold;">Certificados</h4>          
            <div class="row" style="margin-top: 35px; padding-bottom: 45px;">
              <div class="col-md-12">
               <center>
                  <p style="margin-top: 69px; width: 100%;">AÚN NO TIENES CERTIFICADOS </p>
                </center>
              </div>
            </div>
        </div>
